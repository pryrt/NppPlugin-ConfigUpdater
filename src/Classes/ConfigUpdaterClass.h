...
private:
	...
	bool _updateOneTheme(tinyxml2::XMLDocument* pModelStylerDoc, std::wstring themeDir, std::wstring themeName, bool isIntermediateSorted = false);	// Updates one particular theme or styler file
	...
	void _updateLangs(bool isIntermediateSorted = false);														// updates langs.xml to match langs.model.xml
